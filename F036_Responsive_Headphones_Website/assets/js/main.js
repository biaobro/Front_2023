...
const blurHeader = () => {
    ...
    // when the scroll is greater than 50 viewport height, add the blurHeader class
...
const scrollUp = () => {
    ...
    // when the scroll higher than 350 viewport height, add the class
...
sr.reveal(`.home__tooltip, .home__button, .model__button`, {origin: 'right', opacity: 1})
